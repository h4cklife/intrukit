...
class Module:
    ...
    __title__ = 'extractor.emails'
    __date__ = '2017-11-13'
    __rank__ = 'normal'
    __description__ = 'This is a scrapy spider that will extract email addresses from the source code of web pages'
    __details__ = 'None'
    ...
    def __init__(self,
                 ...
                 DOMAINS=None,
                 FEEDFORMAT='json',
                 FEEDURI='results/data/custom_results.json',
                 LOGFILE='results/data/custom_debug.log',
                 LOGLEVEL='DEBUG',
                 STRING='Example'):
        ...
        self.__dict__['STRING'] = {"value": STRING, "required": True,
                                     "description": "String to look for in the source code"}
    ...
    def run(self):
        ...
        class MySpider(scrapy.Spider):
            ...
            def parse(self, response):
                ...
                # CODE for scraping custom strings
                strings = hxs.xpath("//*[contains(text(),'{}')]".format(self.__dict__['STRING']['value'])).extract()
